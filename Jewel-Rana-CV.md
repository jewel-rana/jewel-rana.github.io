...
[GitHub](https://github.com/jewel-rana) · [LinkedIn](https://www.linkedin.com/in/mdjewelrana/) · [Website](https://jewel-rana.github.io) · [X / Twitter](https://twitter.com/jewel1989r)
...
- **Backend:** PHP, Laravel, CodeIgniter, CakePHP, Node.js, Express, REST APIs, WordPress
...
### Software Engineer | Newroz Technologies Limited
...
**Technologies:** Laravel, PHP, MySQL, Redis, REST APIs, Vue.js

### Software Engineer | Jolzatra Limited
...
### Software Engineer | Dream71 Bangladesh Ltd.
**Dhaka, Bangladesh** · 2018 – 2020
...
### Web Developer | eSoft Arena Ltd.
**Dhaka, Bangladesh** · 2017 – 2018
...
**Technologies:** Laravel, CodeIgniter, CakePHP, WordPress, MySQL, MongoDB, Vue.js, Nginx, Apache

### Web Developer | The Net Heads Ltd.
...
### Jolzatra Online Booking System
...
- [Related package](https://github.com/jewel-rana/mikrotik)

### Crew Management System — Bangladesh Biman
**Software Engineer** · Case study
...
### Library Management for BIISS
**Software Engineer** · Case study

Library management system for BIISS, later revisited in a revamp effort.

- Domain-specific operational tooling

**Technologies:** PHP, JavaScript

- [Related repository](https://github.com/jewel-rana/biiss-revamp)

## Open Source & Public Work

- **[mikrotik](https://github.com/jewel-rana/mikrotik)** (PHP) — Laravel-oriented MikroTik package with billing-system oriented capabilities.
- **[laravel-activity-mongodb](https://github.com/jewel-rana/laravel-activity-mongodb)** (PHP) — Laravel model activity logging backed by MongoDB.
- **[easy-firebase-push](https://github.com/jewel-rana/easy-firebase-push)** (PHP) — Straightforward Firebase push notification package for PHP apps.
...
### Bachelor of Arts — Kabi Nazrul Govt. College
**Dhaka, Bangladesh** · 2008 – 2012

Arts

### HSC — Barishur Anchalik High School & College
**Keraniganj, Dhaka, Bangladesh** · 2005 – 2006

Humanities
- CGPA 3.10 / 5.0

### SSC — D.G.L High School
**Bakerganj, Barisal, Bangladesh** · 2003 – 2004
